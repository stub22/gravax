...
private trait TriModuliSpcStuff
 ...
 *
 * https://katyhristova.medium.com/a-soft-dive-into-moduli-spaces-all-triangles-form-a-triangle-e68f6d80b676
 *
 * Nice textbook writeup for students, but not quite free to access "Delving Deeper: Heron Triangles and Moduli Spaces"
 * https://doi.org/10.5951/MT.101.9.0656
 * https://pubs.nctm.org/view/journals/mt/101/9/article-p656.xml
 *
 *
 */
